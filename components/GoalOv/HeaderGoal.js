...
function HeaderGoal () {
    ...
    <View style = {styles.headerContainer}>
        <TouchableOpacity style= {styles.backButton}>
            <Ionicons name="chevron-back-outline" color={'#010256'} size={15}/>
            <Text style = {styles.textStyle}>
            Back
            </Text>
        </TouchableOpacity>
        <View style= {styles.containerPubPriv}>
            <TouchableHighlight style = { isEnabled? styles.dipilih : styles.tidakDipilih} onPress={pilihPublik}>
            <Text style = {styles.textStyle}>Publik</Text>
            </TouchableHighlight>

            <TouchableHighlight style = { isEnabled? styles.tidakDipilih: styles.dipilih} onPress={pilihPrivate}>
